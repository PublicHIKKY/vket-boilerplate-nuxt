...
## File: layers/base/app/composables/useScaleUpAnimation.ts
````typescript
import type { Ref } from 'vue'
...
## File: layers/base/app/utils/animation/index.ts
````typescript
export * from './scale-up'
````

## File: layers/base/app/utils/animation/README.md
````markdown
# Animation Utilities
...
## File: layers/base/app/utils/animation/scale-up.ts
````typescript
/**
