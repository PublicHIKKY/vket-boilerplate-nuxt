...
declare global {
  // @ts-ignore
  export type { Component, ComponentPublicInstance, ComputedRef, DirectiveBinding, ExtractDefaultPropTypes, ExtractPropTypes, ExtractPublicPropTypes, InjectionKey, MaybeRef, MaybeRefOrGetter, PropType, Ref, ShallowRef, Slot, Slots, VNode, WritableComputedRef } from 'vue'
  // @ts-ignore
  export type { Method } from '../app/utils/api'
  // @ts-ignore
  export type { Repositories, Repository, RepositoryKey } from '../app/utils/factory'
  // @ts-ignore
