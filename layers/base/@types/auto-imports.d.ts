...
declare global {
  // @ts-ignore
  export type { Component, ComponentPublicInstance, ComputedRef, DirectiveBinding, ExtractDefaultPropTypes, ExtractPropTypes, ExtractPublicPropTypes, InjectionKey, MaybeRef, MaybeRefOrGetter, PropType, Ref, Slot, Slots, VNode, WritableComputedRef } from 'vue'
  // @ts-ignore
  ...
  // @ts-ignore
  export type { ConsoleMethod, LogLevel } from '../app/utils/console'
  // @ts-ignore
  export type { Method } from '../app/utils/default-api'
  // @ts-ignore
  export type { ApiAccess, DefaultRepositories, DefaultRepository, DefaultRepositoryKey, MakeRepository } from '../app/utils/default-factory'
  // @ts-ignore
  export type { AsyncDataResponse, Paging, ResponseStatus } from '../app/utils/response'
  // @ts-ignore
  export type { Nullable, Overwrite, ValueOf } from '../app/utils/types/types'
  // @ts-ignore
